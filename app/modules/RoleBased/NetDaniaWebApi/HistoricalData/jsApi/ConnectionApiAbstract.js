...
class ConnectionApiAbstract {
     ...
     */
    snapshotData(subscriber, symbol, timescale, provider, points) {
     ...
     *
     */
    snapshotDataFromDate(subscriber, symbol, timescale, provider, startDate, points) {
        throw new UnimplementedException("snapshotDataFromDate is not implemented on connection API");
    }

    /**
     * Snapshot instrument data by a given date interval
     * @param {CommonSubscriber} subscriber
     * @param {string} symbol
     * @param {int} timescale
     * @param {string} provider
     ...
     *
     */
    snapshotDataBetweenDate(subscriber, symbol, timescale, provider, startDate, endDate, points) {
        throw new UnimplementedException("snapshotDataBetweenDate is not implemented on connection API");
    }
