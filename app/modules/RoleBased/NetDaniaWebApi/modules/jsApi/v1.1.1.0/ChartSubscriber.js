...
(function (NetDania) {
    ...
    NetDania.ChartSubscriber.prototype.snapshotData = function (
        ...
        if (typeof this.chartConnectionApi.snapshotData === 'function') {
            var requestId;
            if (this.chartConnectionApi.snapshotData.length == 6) {
                ...
                /**
                 * For Ayondo we also send quoteType
                 */
                requestId = this.chartConnectionApi.snapshotData(symbol, timescale, provider, quoteType, this.id);
            }
