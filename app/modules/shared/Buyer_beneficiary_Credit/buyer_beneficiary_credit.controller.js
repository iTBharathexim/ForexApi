...
function buyer_beneficiary_credit_getAll(newPackage, callback) {
    Buyer_Beneficiary_CreditModel.buyer_beneficiary_credit_getAll(newPackage, (err, res) => {
        if (err) {
            callback(err, null);
        } else if (res) {
            callback(null, res);
...
module.exports = {
    ...
    buyer_beneficiary_credit_getAll:buyer_beneficiary_credit_getAll
};
